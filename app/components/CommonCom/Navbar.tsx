...
const NavbarUserButton = dynamic(() => import("./NavbarUserButton"), {
    ssr: false,
    loading: () => (
        <div className="w-10 h-10 flex items-center justify-center p-2 text-foreground/90">
        ...
        <>
            <header ref={navRef} className="fixed top-0 z-50 w-full pointer-events-none">
                ...
                <div className="flex items-center gap-1.5 sm:gap-3 md:gap-6 relative z-50">
                    ...
                    <div className="hidden xl:block">
                        <NavbarUserButton variant="desktop" />
                    </div>
                        ...
                        <div className="flex-1 px-6 py-8 pb-24">
                            ...
                            <div className="mt-8 pt-8 border-t border-foreground/10 flex flex-col gap-5">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <NavbarUserButton variant="mobile" onCloseMobile={() => setIsMenuOpen(false)} />
                                </div>
                            </div>
